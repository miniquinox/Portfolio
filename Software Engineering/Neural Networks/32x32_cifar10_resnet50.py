...
# ONE conv(64, 7x7, stride=2)
model.add(Conv2D(64, (7, 7), padding='same', strides=(2,2), input_shape=x_shape, kernel_regularizer=regularizers.l2(weight_decay)))
model.add(Activation('relu'))
model.add(BatchNormalization())
model.add(Dropout(0.3))

# ONE maxpool(stride=2)
...
# ONE conv(128, 3x3, stride=2)
model.add(Conv2D(128, (3, 3), padding='same', strides=(2,2), kernel_regularizer=regularizers.l2(weight_decay)))
model.add(Activation('relu'))
model.add(BatchNormalization())
model.add(Dropout(0.4))
...
# ONE conv(256, 3x3, stride=2)
model.add(Conv2D(512, (3, 3), padding='same', strides=(2,2), kernel_regularizer=regularizers.l2(weight_decay)))
model.add(Activation('relu'))
model.add(BatchNormalization())
model.add(Dropout(0.4))
...
model.save_weights('cifar10_resnet.h5')
